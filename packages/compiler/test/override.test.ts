...
import {DirectorOverrideError, createEffectiveDirectorPlan, hashDirectorPlan} from '../src/index.js';
import {sourceStory, storyDirectorPlan} from './fixture.js';
...
describe('DirectorOverride application', () => {
  ...
  it('rejects a stale source hash and RenderPlan/Timeline paths', async () => {
    await expect(createEffectiveDirectorPlan({story: sourceStory, directorPlan: storyDirectorPlan, overrides: [{
