...
export const goldenFixtureV2 = RenderPlanSchema.parse({
  ...
  timeline: {
    ...
    cameraTracks: [{shotId: 'shot-01', position: [{frame: 0, value: {x: 24, y: 8}, easing: 'linear'}, {frame: 119, value: {x: 48, y: 8}, easing: 'linear'}], zoom: [{frame: 0, value: 1, easing: 'hold'}]}],
    ...
    ownershipEvents: [
      ...
      {id: 'lantern-detach', frame: 80, type: 'detach', entityId: 'lantern', from: {kind: 'entity', entityId: 'farmer', slot: 'rightHand'}, to: {kind: 'world', environmentId: 'farm'}, mode: 'socket', preserveWorldTransform: true},
      {id: 'rabbit-detach', frame: 90, type: 'detach', entityId: 'rabbit', from: {kind: 'entity', entityId: 'farmer', slot: 'arms'}, to: {kind: 'world', environmentId: 'farm'}, mode: 'baked', preserveWorldTransform: true},
    ],
