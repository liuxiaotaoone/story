  ...
  return RenderPlanSchema.parse({
    ...
    timeline: {
      ...
      entityTracks: [
        {
          entityId: 'farmer',
          groundPosition: [{frame: 0, value: {u: 0.21, v: 0.58}, easing: 'hold'}, {frame: 299, value: {u: 0.21, v: 0.58}, easing: 'hold'}],
          scale: [{frame: 0, value: {x: 0.205, y: 0.205}, easing: 'linear'}, {frame: 14, value: {x: 0.208, y: 0.208}, easing: 'linear'}, {frame: 29, value: {x: 0.205, y: 0.205}, easing: 'linear'}, {frame: 165, value: {x: 0.205, y: 0.205}, easing: 'linear'}, {frame: 206, value: {x: 0.205, y: 0.205}, easing: 'ease-in'}, {frame: 209, value: {x: 0.211, y: 0.211}, easing: 'linear'}, {frame: 210, value: {x: 0.205, y: 0.205}, easing: 'hold'}],
